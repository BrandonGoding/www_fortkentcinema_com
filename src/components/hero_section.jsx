                ...
                <div className="relative z-10 pt-14 lg:w-full lg:max-w-2xl">
                    ...
                    <div className="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
                        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                            ...
                            <h1 className="text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-7xl">Fort
                                Kent Cinema
                            </h1>
                            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
                                Located in the heart of downtown Fort Kent, our cozy two-screen theater combines modern
                                technology with a welcoming atmosphere, perfect for enjoying the latest blockbusters,
                                family favorites, and indie gems. <br/><br/>Join
