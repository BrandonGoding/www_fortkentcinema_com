            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:max-w-none">
                    <div className="text-center">
                        ...
                        <p className="mt-4 text-lg/8 text-gray-300">Fort Kent Cinema is a cozy, two-screen theater
                            nestled in the heart of downtown Fort Kent. Each auditorium offers comfortable seating for
                            up to 100 guests, creating an intimate and inviting moviegoing experience. Whether you're
                            here for the latest blockbuster or a family-friendly adventure, our modern projection and
                            sound systems ensure you enjoy every moment. Locally owned and operated, we take pride in
                            providing a friendly, welcoming environment for our community to relax, snack, and escape
                            into the world of film.</p>
                    </div>
                        ...
                        {nowPlaying.map((movie, idx) => (
                            <div key={idx} className="flex flex-col bg-white/5 p-8">
                                <dt className="text-sm/6 font-semibold text-gray-300">
                                    <img src={movie?.omdb_json?.Poster} alt={`${movie.title} Poster`}
                                ...
                                <dd className="order-first text-3xl font-semibold tracking-tight text-white mb-5">
                                    ...
                                    <br/>
                                    <small>
                                        {new Date(movie.currentBooking.booking_start_date).toLocaleDateString('en-US', {
                                            month: 'numeric',
                                            day: 'numeric'
                                        })} -
                                        {new Date(movie.currentBooking.booking_end_date).toLocaleDateString('en-US', {
                                            month: 'numeric',
                                            day: 'numeric',
                                        })}
                                    </small></dd>
