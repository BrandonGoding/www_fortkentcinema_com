        ...
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    ...
                    <p className="mt-2 text-lg/8 text-gray-600">Welcome to the Fort Kent Cinema Blog — your
                        behind-the-scenes pass to everything happening at our hometown theater. Here, we share the
                        latest movie news, upcoming releases, special events, and community spotlights. You’ll also find
                        staff picks, throwbacks to classic films, and stories from around the St. John Valley. Whether
                        you're a film fanatic or just love a good night out, we hope this blog brings you a little extra
                        movie magic between visits.</p>
                </div>
                <div
