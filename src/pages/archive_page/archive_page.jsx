    ...
    return (
        <>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto text-center">
                        ...
                        <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
                            Welcome to the Fort Kent Cinema Film Archive — a curated journey through every movie we've
                            ever shown on the big screen. From blockbuster premieres to indie gems, family favorites to
                            cinematic epics, this archive celebrates the diverse stories that have lit up our screens
                            and brought our community together. Take a stroll down memory lane and rediscover the films
            ...
            <div className="max-w-2/3 m-auto">
                <div
                    className="mx-auto mt-16 mb-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    {sortedFilms.map((film) => (
                        ...
                        >
                            <img alt="" src={film.omdb_json.Poster}
